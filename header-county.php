            ...
            <div class="show-menu show-menu-sm show-menu-md">
                <nav id="main-nav">
                    <ul>
                        ...
                        <li>
                            <a href="/" class="media-obj media-obj--center nav--get-involved"><span class="media-obj--figure icon"><svg aria-hidden="true"><use xlink:href="#icon--involved"></use></svg></span><span class="media-obj--body">Let Involved</span></a>
                        </li>
                    </ul>
                </nav>
            </div><!-- end .show-menu -->
